                   ...
                   <?=
                    ...
                    <li>
                      ...
                      <li> <?php
                        ...
                        if ($loguser) {
                            echo $this->Html->link(  $user = $loguser['username'], ['controller' => 'Users', 'action' => 'view',$loguser['user_id']]);
                    ...
                    <li>
                        <?= $this->Html->link('creole haiti', ['action' => 'changeLang', 'HT'], ['escape' => false]) ?>
